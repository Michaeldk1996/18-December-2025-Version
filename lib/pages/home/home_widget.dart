...
class _HomeWidgetState extends State<HomeWidget> {
              ...
              children: [
                ...
                GestureDetector(
                  onTap: ()async{
                    ...
                    if (res is int){
                      logFirebaseCustomEvent('mobile_ChangeBankroll');
                      bankrol = res;
                    }
                    refresher.value++;
                  },
                ...
                GestureDetector(
                  onTap: ()async{
                    ...
                    if (res is String){
                      logFirebaseCustomEvent('mobile_ChangeStrategy');
                      strategy = res;
                    }
                    refresher.value++;
                  },
                  ...
                  InkWell(
                    ...
                    onLongPress: () async {
                      ...
                      if (_model.selectedAction == 'Delete') {
                        logFirebaseCustomEvent('mobile_DeleteRecord');
                        ...
                        if (listViewCommunicationRecord.type == 'Tip') {
                          logFirebaseCustomEvent('mobile_ModifyTip');
                          ...
                          logFirebaseCustomEvent('mobile_ModifyMessage');
                          logFirebaseEvent('TipItem_navigate_to');
  ...
  void logOut()async{
    ...
    if (res is bool && res){
      ...
      await logFirebaseCustomEvent('mobile_logout');
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseCustomEvent('Mobile_login');
      ...
      //   ));
      // }
      //! i have no idea why is loading all users
                                              ...
                                              Padding(
                                                ...
                                                child: FFButtonWidget(
                                                  onPressed: () async {
                                                    ...
                                                    logFirebaseCustomEvent('mobile_Insights');
                                                    _model.tipMode = 1;
                                                    safeSetState(() {});
                                                  },
                                                  text: 'Insights',
                                              ...
                                              Padding(
                                                ...
                                                child: FFButtonWidget(
                                                  onPressed: () async {
                                                    logFirebaseEvent('HOME_PAGE_Column_afftpejl_ON_TAP');
                                                    logFirebaseEvent('Column_update_page_state');
                                                    logFirebaseCustomEvent('mobile_Bets');
                                                    _model.tipMode = 2;
                                                    safeSetState(() {});
                                                  },
                                                  text: 'Bets',
                                                                ...
                                                                Material(
                                                                  ...
                                                                  child: Container(
                                                                    ...
                                                                    child: InkWell(
                                                                      ...
                                                                      highlightColor: Colors.transparent,
                                                                      onTap: () async {
                                                                        logFirebaseCustomEvent('mobile_SendNotification');
                                                            ...
                                                            child: Row(
                                                              ...
                                                              children: [
                                                                ...
                                                                InkWell(
                                                                  ...
                                                                  highlightColor: Colors.transparent,
                                                                  onTap: () async {
                                                                    logFirebaseCustomEvent('mobile_AddMessage');
                                                            ...
                                                            child: Row(
                                                              ...
                                                              children: [
                                                                ...
                                                                InkWell(
                                                                  ...
                                                                  highlightColor: Colors.transparent,
                                                                  onTap: () async {
                                                                    logFirebaseCustomEvent('mobile_AddTip');
