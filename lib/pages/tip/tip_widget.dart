                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: TextFormField(
                            ...
                            autofocus: true,
                            obscureText: false,
                            decoration: context.textfieldDecoration('Enter Minimum Odd'),
                            style: context.textFieldStyle,
                            textAlign: TextAlign.start,
                            keyboardType: const TextInputType.numberWithOptions(decimal: true),
                          ),
                              ...
                              child: Column(
                                ...
                                children: [
                                  if (_model.uploadedFileUrl_uploadData != '') 
                                    Image.network(_model.uploadedFileUrl_uploadData, fit: BoxFit.cover, width: double.infinity, height: MediaQuery.of(context).size.height *.20)
                                  else
                                    ...[
