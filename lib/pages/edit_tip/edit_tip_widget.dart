...
import 'edit_tip_model.dart';
export 'edit_tip_model.dart';

class EditTipWidget extends StatefulWidget {
  const EditTipWidget({
    super.key,
    required this.tripData,
  });

  final DocumentReference? tripData;

  static String routeName = 'EditTip';
  static String routePath = '/editTip';

  @override
  State<EditTipWidget> createState() => _EditTipWidgetState();
}

class _EditTipWidgetState extends State<EditTipWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditTipModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'EditTip'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      safeSetState(() {});
      logFirebaseEvent('EditTip_update_app_state');
      FFAppState().analyses = functions
          .convertStringToJSONList(_model.selectedTrip!.analyses.toList())
          .toList()
          .cast<dynamic>();
      safeSetState(() {});
      logFirebaseEvent('EditTip_set_form_field');
      safeSetState(() {
        _model.titleTextController?.text = _model.selectedTrip!.title;
      });
      logFirebaseEvent('EditTip_set_form_field');
      safeSetState(() {
