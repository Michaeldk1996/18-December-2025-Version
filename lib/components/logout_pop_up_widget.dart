...
import 'logout_pop_up_model.dart';
export 'logout_pop_up_model.dart';
              ...
              child: Column(
                ...
                children: [
                  ClipRRect(
                    ...
                    child: Image.asset(
                      'assets/images/Frame_2147238680_(1).png',
                      width: 56.0,
                      height: 56.0,
                      fit: BoxFit.cover,
                    ),
                  ...
                  Padding(
                    padding:
                        EdgeInsetsDirectional.fromSTEB(45.0, 6.0, 45.0, 24.0),
                    child: Text(
                    ...
                    child: Row(
                      ...
                      children: [
                        FFButtonWidget(
                          onPressed: () async {
                            logFirebaseEvent(
                                'LOGOUT_POP_UP_COMP_CANCEL_BTN_ON_TAP');
                        ...
                        FFButtonWidget(
                          onPressed: () async {
                            logFirebaseEvent(
                                'LOGOUT_POP_UP_COMP_LOGOUT_BTN_ON_TAP');
