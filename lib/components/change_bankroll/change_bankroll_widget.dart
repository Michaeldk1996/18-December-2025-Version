...
class _ChangeBankrollWidgetState extends State<ChangeBankrollWidget> {
  ...
  void initState() {
    ...
    _model.textController ??= TextEditingController(
        text: valueOrDefault(currentUserDocument?.bankroll, ''));
                ...
                children: [
                  Padding(
                    ...
                    child: ClipRRect(
                      borderRadius: BorderRadius.circular(8.0),
                      child: Image.asset(
                        'assets/images/Frame_2147238680_(2).png',
                        width: 56.0,
                        height: 56.0,
                        fit: BoxFit.cover,
                      ),
                  ...
                  Padding(
                    ...
                    child: Text(
                      'Enter your total bankroll. This will be used to create your personalized staking plan.',
                    ...
                    child: Row(
                      ...
                      children: [
                        FFButtonWidget(
                          onPressed: () async {
                            logFirebaseEvent(
                                'CHANGE_BANKROLL_COMP_CANCEL_BTN_ON_TAP');
                        ...
                        FFButtonWidget(
                          onPressed: () async {
                            logFirebaseEvent(
                                'CHANGE_BANKROLL_COMP_CONFIRM_BTN_ON_TAP');
                            logFirebaseEvent('Button_dismiss_dialog');
