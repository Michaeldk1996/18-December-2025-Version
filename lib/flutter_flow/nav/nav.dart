      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => MessageWidget(
            tipData: params.getParam(
              'tipData',
              ParamType.DocumentReference,
              isList: false,
              collectionNamePath: ['communication'],
            ),
          ),
        ),
        FFRoute(
        ...
        FFRoute(
          name: AnalysesWidget.routeName,
          path: AnalysesWidget.routePath,
          builder: (context, params) => AnalysesWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: EditTipWidget.routeName,
          path: EditTipWidget.routePath,
          builder: (context, params) => EditTipWidget(
        ...
        FFRoute(
          ...
          builder: (context, params) => HomeWidget(
            initialPageIndex: params.getParam(
              'initialPageIndex',
              ParamType.int,
            ),
          ),
        ...
        FFRoute(
          name: TermsAndServiceWidget.routeName,
          path: TermsAndServiceWidget.routePath,
          builder: (context, params) => TermsAndServiceWidget(),
        ),
        FFRoute(
